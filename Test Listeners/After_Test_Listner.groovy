 ...
 * 
 * import com.kms.katalon.core.webservice.keyword.WSBuiltInKeywords as WS import
 ...
 * 
 * import com.kms.katalon.core.annotation.BeforeTestCase import
 ...
 * com.kms.katalon.core.context.TestSuiteContext class AfterTestListener {
 * 
 * // @BeforeTestCase // def sampleBeforeTestCase() { // // Open the browser //
 * WebUI.openBrowser('') // // // Navigate to the specified URL //
 * WebUI.navigateToUrl('https://practicetestautomation.com/practice-test-login/'
 * ) // // // Maximize the browser window // WebUI.maximizeWindow() // } //
 * // @AfterTestCase // def sampleAfterTestCase() { // // Close the browser //
 * WebUI.closeBrowser() // } // }
 * 
 */